...
public class CommentValidatorTest {
	...
	public void setUp() throws Exception {
		...
		User bobCopy = new User(null, "bob", null, "email@email.com", "fbTest", -1);
	...
	public void testAuthorMismatch() {
		goodNewComment.setUser(new User("joe", "joe", "", "email@email.com", "fbTest", 2));
	...
	public void testBadAuthor() {
		goodNewComment.setUser(new User(null, null, null, "email@email.com", "fbTest", -1));
		checkFieldIssue(defaultSession, goodNewComment, "user");
		goodNewComment.setUser(new User(null, "blah", null, "email@email.com", "fbTest", -1));
		checkFieldIssue(defaultSession, goodNewComment, "user");
	}
