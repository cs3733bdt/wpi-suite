...
public class DefectValidatorTest {
	...
	@Before
	public void setUp() {
		invalidUser = new User("idontexist", "blah", "1234", "email@email.com", 99);
		...
		tagCopy = new Tag("tag");
		bobCopy = new User(null, "bob", null, "email@email.com", -1);
		...
		existingUserCopy = new User(null, "joe", null, "email@email.com", -1);
	...
	public void testGoodUpdatedDefect() {
		...
		checkNoIssues(new Session(new User(null, "someguy", null, "email@email.com", 50), testProject, mockSsid), goodUpdatedDefect,
				Mode.EDIT);
