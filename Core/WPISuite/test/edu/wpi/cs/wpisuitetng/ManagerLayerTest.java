...
public class ManagerLayerTest {
	...
	{
		fake = new User("fake","fake","fake", "email@email.com", "fbTest", 0);
		uniqueFake = new User("asdf","asdf","asdf", "email@email.com", "fbTest", 0);
		fakeList = new User[1];
	...
	public void testDBSession() throws WPISuiteException
	{
		...
		User[] arr = new User[1];
		db.save(new User("andrew", "ahurle", "p", "email@email.com", "fbTest", 0));
