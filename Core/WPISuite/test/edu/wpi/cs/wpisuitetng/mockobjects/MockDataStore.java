...
public class MockDataStore implements Data {
	...
	private MockDataStore()
	{
		...
		models.add(new User("steve", "steve",null, "email@email.com", "fbTest", 0));
		models.add(new User("fred","fred",null, "email@email.com", "fbTest", 1));
		models.add(new User("jeff","jeff",null, "email@email.com", "fbTest", 2));
		models.add(new User("tyler","tyler",null, "email@email.com", "fbTest", 3));
