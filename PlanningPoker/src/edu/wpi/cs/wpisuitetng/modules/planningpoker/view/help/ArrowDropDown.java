...
/**
 * This class's constructor creates an JLabel containing a Unicode arrow to be
 * used in various Help Panels. This class supports a method on the Label called
 * <code>addComponentToGroup(JComponent comp)</code> which adds the drop down
 * functionality to <code>comp</code>.
 * 
 * @author Justin
 * 
 */
public class ArrowDropDown extends JLabel {
	...
	/**
	 * This method adds a component to the group of components associated with
	 * this arrow label. This should be run on the components that you want to
	 * disappear when the arrow is toggled
	 * 
	 * @param comp
	 *            is the component to be added to the group
	 */
	...
	/**
	 * Adds the mouse listener to the arrow label. This method is not designed
	 * for use other than in a constructor for a JLabel.
	 */
	...
	/**
	 * called to swap the visibility state of the components also updates
	 * isExpanded boolean
	 */
	private void switchComponentState() {
		...
		for (JComponent c : associatedComponents) {
			c.setVisible(isExpanded); // this flips the state of the component
										// visibilities
		}
	...
	/**
	 * Changes the icon for the arrow. This method is called subsequently to
	 * switchComponentState()
	 */
