 ...
 * contents of the requirement text fields to the model as a new requirement.
 * 
...
public class UpdateRequirementController {
	...
	private static UpdateRequirementController instance = null;
	...
	/**
	 * 
	 * @return the instance of the UpdateRequirementController or creates one if
	 *         it does not exist.
	 */
	 ...
	 *            is the requirement to be updated to the server.
	 */
	public void updateRequirement(Requirement newRequirement) {
		Request request = Network.getInstance().makeRequest(
				"requirementmanager/requirement", HttpMethod.POST); // POST ==
																	// update
		request.setBody(newRequirement.toJSON()); // put the new requirement in
