...
public class CustomJTextField extends JTextField implements IDataField {
	/** @see JTextField#JTextField() */
	protected CustomJTextField() {
	};

	/** @see JTextField#JTextField(String) */
	protected CustomJTextField(String string) {
		super(string);
	}

	/** @see JTextField#JTextField(String, int) */
	protected CustomJTextField(String string, int columns) {
