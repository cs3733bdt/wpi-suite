...
import edu.wpi.cs.wpisuitetng.modules.planningpoker.requirementmodels.characteristics.AcceptanceTest;
import edu.wpi.cs.wpisuitetng.modules.planningpoker.requirementmodels.characteristics.Attachment;
import edu.wpi.cs.wpisuitetng.modules.planningpoker.requirementmodels.characteristics.DevelopmentTask;
import edu.wpi.cs.wpisuitetng.modules.planningpoker.requirementmodels.characteristics.NoteList;
import edu.wpi.cs.wpisuitetng.modules.planningpoker.requirementmodels.characteristics.RequirementPriority;
import edu.wpi.cs.wpisuitetng.modules.planningpoker.requirementmodels.characteristics.RequirementStatus;
import edu.wpi.cs.wpisuitetng.modules.planningpoker.requirementmodels.characteristics.RequirementType;
import edu.wpi.cs.wpisuitetng.modules.planningpoker.requirementmodels.characteristics.TestStatus;
import edu.wpi.cs.wpisuitetng.modules.planningpoker.requirementmodels.characteristics.TransactionHistory;
...
public class Requirement extends AbstractModel {
	...
	/** the total number of users who already estimated */
	private int numOfEstUser;
	...
	public Requirement() {
		...
		//should figure out numOfEstUser
		numOfEstUser=0;
	 ...
	 * @param numOfEstUser
	 *            The total number of the users who already estimated
	 * @param effort
	...
	public Requirement(int id, String name, String release,
			...
			String description, int estimate, int numOfEstUser, int effort) {
		this.id = id;
		this.name = name;
		...
		this.numOfEstUser=numOfEstUser;
	...
	/**
	 * Getter for the numOfEstUser
	 * 
	 * @return the number of users already estimated
	 */
	
	public int getNumOfEstUser(){
		return numOfEstUser;
	}
	
	/**
	 * Setter for numOfEstUser
	 * TODO the method of counting the number
	 * @param the number of users already estimated
	 */
	
	public void setNumOfEstUser(int numOfEstUser){
		this.numOfEstUser=numOfEstUser;
	}
	/**
