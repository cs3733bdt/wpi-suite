...
public class NewLeftHalfCreateGamePanel extends JScrollPane {
	...
	public NewLeftHalfCreateGamePanel() {
		...
		descriptionTextField = new JTextArea();				//Initializes the textarea for the game description
		...
		descPane.setPreferredSize(new Dimension(200, 250));
        ...
        layout.putConstraint(SpringLayout.WEST, descPane, 5, SpringLayout.EAST, descLabel); 		//Adds the name textfield to the right of the name label
        layout.putConstraint(SpringLayout.NORTH, descPane, 5, SpringLayout.SOUTH, nameTextField); 	//Adds the name textfield to the far top
        layout.putConstraint(SpringLayout.EAST, descPane, -5, SpringLayout.EAST, leftView);			//Makes sure the right side of the textfield stretches with the right side of the container
